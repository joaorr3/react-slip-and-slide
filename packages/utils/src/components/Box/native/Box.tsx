...
export const BoxBase = (
  ...
  const [measurements, setMeasurements] = React.useState<BoxMeasurements>({ width: 0, height: 0 });
  ...
  return (
    <TouchableWithoutFeedback onPress={onPress}>
      <StyledBox ref={viewRef} styles={styles} onLayout={handleOnLayout} {...merge(native, rest)}>
        {children}
      </StyledBox>
